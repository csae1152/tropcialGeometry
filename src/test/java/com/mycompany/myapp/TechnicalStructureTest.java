...
@AnalyzeClasses(packagesOf = TropicalGeometryApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(TropicalGeometryApp.class), alwaysTrue())
